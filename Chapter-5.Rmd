...
ggplot(df, aes(x = microsite, y = mean_ambient_temp)) +
  geom_boxplot() +
  labs(
       x = "Factor",
...
### Check Ground temp
ggplot(df, aes(x = microsite, y = mean_ground_temp)) +
  geom_boxplot() +
  labs(
       x = "Factor",
...
abundance_density <- ggplot(df, aes(shrub_density, abundance, color = microsite)) +
  ...
  labs(x = "Shrub Density", y = "Animal Abundance") + theme_classic() + theme(text = element_text(size = 12), panel.border = element_rect(color = "black", fill = NA, size = 1.5),legend.title = element_blank(), axis.text = element_text(size = 10)) +
  geom_smooth(method = lm, se = TRUE) + labs(tag = "A")
abundance_density
```
```{r}
...
richness_density <- ggplot(df, aes(shrub_density, richness, color = microsite)) +
  ...
  geom_smooth(method = lm, se = TRUE) + labs(tag = "B")
richness_density
```
```{r}
...
evenness_density <- ggplot(df, aes(shrub_density, evenness, color = microsite)) +
  geom_point(size = 0.5) +
  scale_color_brewer(palette = "Set1") +
  labs(x = "Shrub Density", y = "Evenness") + theme_classic() + theme(text = element_text(size = 12), panel.border = element_rect(color = "black", fill = NA, size = 1.5),legend.title = element_blank(), axis.text = element_text(size = 10)) +
  geom_smooth(method = lm, se = TRUE) + labs(tag = "B")
evenness_density
```
```{r}
...
abundance_ambient <- ggplot(df, aes(mean_ambient_temp, abundance, color = microsite)) +
  geom_point(size = 0.5) +
  scale_color_brewer(palette = "Set1") +
  labs(x = "Ambient Temperature (°C)", y = "Animal Abundance") + theme_classic() + theme(text = element_text(size = 12), panel.border = element_rect(color = "black", fill = NA, size = 1.5),legend.title = element_blank(), axis.text = element_text(size = 10)) +
  geom_smooth(method = lm, se = TRUE) + labs(tag = "A")
abundance_ambient
...
richness_ambient <- ggplot(df, aes(mean_ambient_temp, richness, color = microsite)) +
  geom_point(size = 0.5) +
  scale_color_brewer(palette = "Set1") +
  labs(x = "Ambient Temperature (°C)", y = "Richness") + theme_classic() + theme(text = element_text(size = 12), panel.border = element_rect(color = "black", fill = NA, size = 1.5),legend.title = element_blank(), axis.text = element_text(size = 10)) +
  geom_smooth(method = lm, se = TRUE) + labs(tag = "A")
richness_ambient
```
```{r}
...
evenness_ambient <- ggplot(df, aes(mean_ambient_temp, evenness, color = microsite)) +
  geom_point(size = 0.5) +
  scale_color_brewer(palette = "Set1") +
  labs(x = "Ambient Temperature (°C)", y = "Evenness") + theme_classic() + theme(text = element_text(size = 12), panel.border = element_rect(color = "black", fill = NA, size = 1.5),legend.title = element_blank(), axis.text = element_text(size = 10)) +
  geom_smooth(method = lm, se = TRUE) + labs(tag = "A")
evenness_ambient
```
```{r}
...
abundance_ground <- ggplot(df, aes(mean_ground_temp, abundance, color = microsite)) +
  geom_point(size = 0.5) +
  scale_color_brewer(palette = "Set1") +
  labs(x = "Ground Temperature (°C)", y = "Animal Abundance") + theme_classic() + theme(text = element_text(size = 12), panel.border = element_rect(color = "black", fill = NA, size = 1.5),legend.title = element_blank(), axis.text = element_text(size = 10)) +
  geom_smooth(method = lm, se = TRUE)  + labs(tag = "A")
abundance_ground
```
```{r}
...
# Option 1
my_map_1 <- get_map(location = bounding_box, maptype = "terrain", source = "google", zoom = 11)

ggmap(my_map_1) +
  geom_point(data = site, aes(x = long, y = lat, color = "red"), size = 3, shape = 16) +
...
# Option 4
my_map_4 <- get_map(location = bounding_box, maptype = "satellite", source = "google", zoom = 11)
