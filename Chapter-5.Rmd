...
```
```{r}
### Abundance v Shrub Density
abundance_density <- ggplot(df, aes(shrub_density, abundance, color = microsite)) +
  geom_point(size = 0.5) +
  scale_color_brewer(palette = "Set1") +
  labs(x = "Shrub Density", y = "Animal Abundance") + theme_classic() + theme(text = element_text(size = 12), panel.border = element_rect(color = "black", fill = NA, size = 1.5),legend.position = "none",legend.title = element_blank(), axis.text = element_text(size = 10)) +
...
richness_density <- ggplot(df, aes(shrub_density, richness, color = microsite)) +
  geom_point(size = 0.5) +
  scale_color_brewer(palette = "Set1") +
  labs(x = "Shrub Density", y = "Richness") + theme_classic() + theme(text = element_text(size = 12), panel.border = element_rect(color = "black", fill = NA, size = 1.5),legend.position = "none",legend.title = element_blank(), axis.text = element_text(size = 10)) +
